...
export function TerminalSection({
  ...
  const variants = {
    default: "space-y-4",
    border: "border border-emerald-500/60 dark:border-green-400/60 rounded-lg p-6 bg-transparent space-y-4",
    card: "border border-emerald-500/60 dark:border-green-400/60 rounded-lg p-6 bg-transparent shadow-lg space-y-4"
  };
